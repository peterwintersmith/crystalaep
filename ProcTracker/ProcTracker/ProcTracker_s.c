...
extern const MIDL_SERVER_INFO IProcTracker_ServerInfo;

extern const RPC_DISPATCH_TABLE IProcTracker_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE IProcTracker___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x7B54806B,0xFFB4,0x4F9D,{0xB5,0x97,0xCD,0x51,0x0F,0xA0,0x94,0xB0}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&IProcTracker_v1_0_DispatchTable,
    0,
    0,
    0,
    &IProcTracker_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE IProcTracker_v1_0_s_ifspec = (RPC_IF_HANDLE)& IProcTracker___RpcServerInterface;
...
extern const MIDL_SERVER_INFO IEventWriterRpc_ServerInfo;

extern const RPC_DISPATCH_TABLE IEventWriterRpc_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE IEventWriterRpc___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x6FD48920,0x3FA9,0x449B,{0xB5,0x1B,0xFC,0x66,0x79,0x63,0x0C,0x58}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&IEventWriterRpc_v1_0_DispatchTable,
    0,
    0,
    0,
    &IEventWriterRpc_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE IEventWriterRpc_v1_0_s_ifspec = (RPC_IF_HANDLE)& IEventWriterRpc___RpcServerInterface;
...
extern const MIDL_SERVER_INFO IUiFeedback_ServerInfo;

extern const RPC_DISPATCH_TABLE IUiFeedback_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE IUiFeedback___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x4B387FFE,0x9E55,0x47CF,{0x87,0x5C,0x1E,0x9F,0xCF,0x1C,0x08,0x3B}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&IUiFeedback_v1_0_DispatchTable,
    0,
    0,
    0,
    &IUiFeedback_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE IUiFeedback_v1_0_s_ifspec = (RPC_IF_HANDLE)& IUiFeedback___RpcServerInterface;
...
extern const MIDL_SERVER_INFO IRealtimeLog_ServerInfo;

extern const RPC_DISPATCH_TABLE IRealtimeLog_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE IRealtimeLog___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x4E63194F,0xF1B8,0x4E37,{0xA5,0xEC,0xCC,0x88,0x26,0xE5,0x3F,0x2D}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&IRealtimeLog_v1_0_DispatchTable,
    0,
    0,
    0,
    &IRealtimeLog_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE IRealtimeLog_v1_0_s_ifspec = (RPC_IF_HANDLE)& IRealtimeLog___RpcServerInterface;
...
static const MIDL_STUB_DESC IProcTracker_StubDesc = 
    {
    (void *)& IProcTracker___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION IProcTracker_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE IProcTracker_v1_0_DispatchTable = 
    {
    6,
    (RPC_DISPATCH_FUNCTION*)IProcTracker_table
    };

static const SERVER_ROUTINE IProcTracker_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)AddProcess,
    (SERVER_ROUTINE)GetProcessIDs,
    (SERVER_ROUTINE)Stop,
    (SERVER_ROUTINE)CreateProtectFileProcess,
    (SERVER_ROUTINE)CheckProtectFileProcess,
    (SERVER_ROUTINE)AddExeToWhitelist
    };

static const MIDL_SERVER_INFO IProcTracker_ServerInfo = 
    {
    &IProcTracker_StubDesc,
    IProcTracker_ServerRoutineTable,
    ProcTracker__MIDL_ProcFormatString.Format,
    IProcTracker_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
...
static const MIDL_STUB_DESC IEventWriterRpc_StubDesc = 
    {
    (void *)& IEventWriterRpc___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION IEventWriterRpc_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE IEventWriterRpc_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)IEventWriterRpc_table
    };

static const SERVER_ROUTINE IEventWriterRpc_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)WriteEventInternal
    };

static const MIDL_SERVER_INFO IEventWriterRpc_ServerInfo = 
    {
    &IEventWriterRpc_StubDesc,
    IEventWriterRpc_ServerRoutineTable,
    ProcTracker__MIDL_ProcFormatString.Format,
    IEventWriterRpc_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
...
static const MIDL_STUB_DESC IUiFeedback_StubDesc = 
    {
    (void *)& IUiFeedback___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION IUiFeedback_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE IUiFeedback_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)IUiFeedback_table
    };

static const SERVER_ROUTINE IUiFeedback_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)UserBoolFeedback
    };

static const MIDL_SERVER_INFO IUiFeedback_ServerInfo = 
    {
    &IUiFeedback_StubDesc,
    IUiFeedback_ServerRoutineTable,
    ProcTracker__MIDL_ProcFormatString.Format,
    IUiFeedback_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
...
static const MIDL_STUB_DESC IRealtimeLog_StubDesc = 
    {
    (void *)& IRealtimeLog___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION IRealtimeLog_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE IRealtimeLog_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)IRealtimeLog_table
    };

static const SERVER_ROUTINE IRealtimeLog_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)SetEnabledFeaturesProcess,
    (SERVER_ROUTINE)GetEnabledFeaturesProcess,
    (SERVER_ROUTINE)AddEntryProcess,
    (SERVER_ROUTINE)GetProcessLogs
    };

static const MIDL_SERVER_INFO IRealtimeLog_ServerInfo = 
    {
    &IRealtimeLog_StubDesc,
    IRealtimeLog_ServerRoutineTable,
    ProcTracker__MIDL_ProcFormatString.Format,
    IRealtimeLog_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
